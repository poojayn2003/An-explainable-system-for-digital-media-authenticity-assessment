...
Trustify AI proposes an **Explainable AI-based digital media and identity verification platform** that combines image forensics, deepfake artifact detection, metadata examination, and behavioral consistency analysis into a single Trust Score — with a plain-language explanation behind every result. This implementation focuses on **image verification**; video and audio are part of the broader problem space but out of scope for this project phase.

## Problem Statement

- **Deepfakes** — face-swapped or synthetically altered photos used to impersonate real people
- **Fake evidence** — synthetic photos submitted in disputes or fraud claims
- **AI-generated images** — fully synthetic media passed off as real
- **Misinformation** — fabricated images that spread faster than any fact-check
...
- **Image analysis** — combined with metadata and persona-level consistency checks
...
2. Preprocess the uploaded image (OpenCV).
...
| Pooja A R  | ML                | 1JB23CD037       |

*Guide:* Vindyashree, Department of Computer Science & Engineering (Data Science)
*Institution:* SJBIT — Academic Year 2026–27
